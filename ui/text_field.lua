...
function M:new( opts )
	...
	function field.inputHandler( e )
		...
		if e.phase == 'ended' or e.phase == "submitted" then 
			...
			e.target.bg.stroke = {type="image", filename="assets/images/brushes/brush1x4.png"}
			e.target.bg.strokeWidth = opts.strokeWidth
			e.target.bg:setStrokeColor( unpack( opts.strokeColor ) )
